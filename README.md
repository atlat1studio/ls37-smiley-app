...
- Catalog JSON:
  `https://cdn.jsdelivr.net/gh/atlat1studio/ls37-smiley-app@v1/ls37-smiley-wallpaper/ls37_updated4.json`
- Any asset:
  `https://cdn.jsdelivr.net/gh/atlat1studio/ls37-smiley-app@v1/<path>`
